    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                if (!(existingVendor !== null)) return [3 /*break*/, 4];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                _a.label = 4;
            case 4: return [2 /*return*/, res.json({ 'message': 'Vendor not found' })];
            case 5: return [2 /*return*/, res.json({ 'message': 'Foods not found!' })];
        }
    });
}); };
