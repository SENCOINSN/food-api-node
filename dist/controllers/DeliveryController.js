...
exports.FindDeliveryUser = exports.UpdateDeliveryUserStatus = exports.EditDeliveryProfile = exports.GetDeliveryProfile = exports.DeliveryLogin = exports.DeliverySignUp = void 0;
...
var DeliverySignUp = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                deliveryUserInputs = (0, class_transformer_1.plainToClass)(Customer_dto_1.CreateDeliveryUserInput, req.body);
...
var DeliveryLogin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                loginInputs = (0, class_transformer_1.plainToClass)(Customer_dto_1.UserLoginInput, req.body);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, exports.FindDeliveryUser)('', deliveryUser.email)];
            case 2:
                profile = _a.sent();
                if (profile) {
...
var FindDeliveryUser = function (id, email) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2: return [4 /*yield*/, models_1.DeliveryUser.findById(id)];
            case 3: return [2 /*return*/, _a.sent()];
        }
    });
}); };
exports.FindDeliveryUser = FindDeliveryUser;
